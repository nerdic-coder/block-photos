...
describe('PhotosService Test Suites', () => {
  ...
  it('get next and previous image', async () => {
    ...
    blockstack.getFile.mockReturnValue(Promise.resolve(JSON.stringify(mockPhotoListResponse)));
  ...
  it('test getPhotoMetaData', async () => {
    ...
    expect(response.uploadedDate).toEqual(mockPhotoListResponse[1].uploadedDate);
  ...
  it('test setPhotoMetaData', async () => {
    ...
    const photosService = new PhotosService();
    const response = await photosService.setPhotoMetaData('test2.jpg', { id: 'test-set.jpg', uploadedDate: '2020-10-10'});
  ...
  it('test setPhotoMetaData no id input', async () => {
    ...
    const photosService = new PhotosService();
    const response = await photosService.setPhotoMetaData(null, { id: 'test-set.jpg', uploadedDate: '2020-10-10'});
  ...
  it('test setPhotoMetaData photo not found', async () => {
    ...
    const photosService = new PhotosService();
    const response = await photosService.setPhotoMetaData('test2-fake.jpg', { id: 'test-set.jpg', uploadedDate: '2020-10-10'});
